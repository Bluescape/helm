 ...
 * use the templates in `<repo>/helm/charts/bluescape-monitoring-dashboards-5/templates/0_template`
   * create a new dashboard directory in `<repo>/helm/charts/bluescape-monitoring-dashboards-5/templates`
...
in `<repo>/helm/charts/bluescape-monitoring-dashboards-5`
...
```
$ cd <repo>/helm/charts/bluescape-monitoring-dashboards-5
...
```
$ cd <repo>/helm/charts
$ helm template /bluescape-monitoring-dashboards-5 | yamllint -
```
...
Note that if the `bluescape-monitoring-dashboards-5` are already installed on your
...
grafana-dashboards-a-atreus     grafana         6               2021-08-09 23:23:16.473682282 +0000 UTC deployed        bluescape-monitoring-dashboards-5-0.2.3   1.16.2
```
...
```
$ cd <repo>/helm/charts
$ helm upgrade --install grafana-dashboards-a-atreus bluescape-monitoring-dashboards-5 -n grafana --dry-run
```
...
$ cd <repo>/helm/charts
$ helm upgrade --install grafana-dashboards-atreus bluescape-monitoring-dashboards-5 -n grafana
```
